...
<html lang="en">
    ...
    <body class="bg-primary-subtle">
                                        ...
                                        <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                            <div class="mb-4 p-0 text-center">
                                                <a href="index.html" class="auth-logo">
                                                    <img src="{{ asset('public/assets/images/logo-dark.png') }}" alt="logo-dark" class="mx-auto" height="28" />
                                                </a>
                                            </div>
                        ...
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <div class="auth-image">
                                    <img src="{{ asset('public/assets/images/auth-images.svg')}}" class="mx-auto img-fluid"  alt="images">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{asset('public/assets/js/pages/crm-dashboard.init.js')}}"></script>
