    ...
    <form action="{{ route('testsave.store') }}" method="POST" id="mainForm">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active p-3" id="personal" role="tabpanel" aria-labelledby="personal-tab">
                ...
                <div class="mb-3">
                    <label>Test Discount (optional)</label>
                    <input type="number" class="form-control" name="testDiscount" step="0.01">
                </div>
            </div>
        ...
        <!-- SUBMIT BUTTON -->
        <div class="mt-3">
            <button type="submit" class="btn btn-success">Submit All Data</button>
        </div>
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    catFilter.addEventListener('change', function() {
        const selectedCategory = catFilter.value;  // e.g. "all", "pathology", "radiology", etc.
    ...
    referralType.addEventListener('change', function() {
        const val = referralType.value;  // "normal", "staff", "external", or "referrer"
    ...
    // Elements for displaying panel info in payment tab
    ...
    function applyPanelDiscount(rawTotal) {
        ...
        const referralVal = referralType.value; // "normal", "staff", "external", "referrer"
    ...
    // Listen for staff or external panel selection changes
    ...
    // Listen for referral type changes (already added above)
    // Initialize values
