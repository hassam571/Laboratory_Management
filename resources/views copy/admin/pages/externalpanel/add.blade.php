                ...
                <form method="POST" action="{{ route('admin.external.store') }}" id="externalPanelForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="panelDes" id="panelDes" class="form-control" placeholder="Enter panel description">{{ old('panelDes') }}</textarea>
                        </div>

                        {{-- If you want a separate createdDate field:
                        <div class="col-md-6 mb-3">
                            <label for="createdDate" class="form-label">Created Date</label>
                            <input type="date" name="createdDate" id="createdDate" class="form-control" value="{{ old('createdDate') }}">
                        </div>
                        --}}
