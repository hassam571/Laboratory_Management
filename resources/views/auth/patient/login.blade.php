                                            ...
                                            <form id="loginForm" action="{{ route('patient.login.post') }}" method="POST">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="emailaddress"
                                                           name="user_name" required placeholder="Enter Your User Id" value="{{ old('user_name') }}">
                                                </div>
                                                <div class="form-group mb-3">
                                                ...
                                                <div class="d-flex flex-wrap gap-2 mb-3">
                                                    <button type="button" class="btn btn-secondary" onclick="fillLogin('a_1', 'a')">Patient</button>
                                                </div>
