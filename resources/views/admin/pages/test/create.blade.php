...
@section('breadcrumb_child', 'Add Test')
                        ...
                        <select name="testCatId" id="testCatId" class="form-select">
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->testCatId }}"
                                    {{ old('testCatId') == $category->testCatId ? 'selected' : '' }}>
                                    {{ $category->testCat }}
                                </option>
                            @endforeach
                        </select>
