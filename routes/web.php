 ...
 Route::middleware(['auth'])->group(function () {
         ...
         Route::prefix('admin')->middleware(['role:admin'])->group(function () {
            ...
            Route::middleware('role:receptionist')->prefix('receptionist')->group(function () {
                    ...
                    Route::get('/receptionist/customers', [ReceptionistController::class, 'index'])->name('receptionist.customers');
                    Route::get('/receptionist/customers/{id}',  [ReceptionistController::class, 'show'])->name('receptionist.customer.details');
    //                 Route::get('receptionist/customers/{id}', [ReceptionistController::class, 'showDetails'])
    //  ->name('receptionist.customer.details');
    ...
    Route::delete('/credit/{credit}', [CreditController::class, 'destroy'])->name('credit.destroy');
            ...
            Route::middleware('role:reporter')->prefix('reporter')->group(function () {
                    ...
                    // Route::get('/report/test/{addTestId}', [TestReportController::class, 'showTestReport'])->name('report.test');
